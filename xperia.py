...
useragents = ('Mozilla/5.0 (Linux; Android 7.1; G8141 Build/45.0.A.1.226) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36')
ua = 'Mozilla/5.0 (Linux; Android 7.1; G8141 Build/45.0.A.1.226) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36'
uas = 'Mozilla/5.0 (Linux; Android 7.1; G8141 Build/45.0.A.1.226) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36'
ip = requests.get('https://api.ipify.org').text
uas = random.choice(["Mozilla/5.0 (Linux; Android 7.1; G8141 Build/45.0.A.1.226) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.91 Mobile Safari/537.36"])
id = []
cp = []
ok = []
loop = 0
...
def pilih_menubapi():
    ...
    print'[×]\x1b[0;92m facebook.com/kkiirraannaa\x1b[0;97m'
    os.system('echo -e "--------------------------------------\n" | lolcat')
    print''
